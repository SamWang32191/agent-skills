...
|---|---|---|
| Shared workflow core | `skills/` (26 skills, including the Codex setup skill) | Portable `SKILL.md` workflows used by every integration |
...
| Codex adapter | `.codex-plugin/`, `.agents/plugins/`, `skills/install-codex-assets/` | Codex plugin metadata, marketplace registration, and optional global agent-persona installation; Codex consumes `skills/` directly |
...
| Contributor tooling | `scripts/`, `evals/`, `.github/workflows/` | Validation, routing evals, and CI |
